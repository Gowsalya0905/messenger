...
class Usertracking
{
    ...
    private $needed_fields = array(
        ...
        array('name' => 'user_login_id', 'type' => 'int', 'forge_type' => 'int', 'forge_constraint' => '100'),
    ...
    public function track_this()
    {
      ...
      //  return true;
        ...
        if ($this->configuration['user_identifier'] !== null && is_array($this->configuration['user_identifier'])) {
         ...
         $input_data['user_login_id'] = getCurrentUserid();
       // $input_data['user_login_id'] = 1;

        //Add it to the database
        //$this->CI->load->database();

        $result =  $this->CI->common_model->updateInfo('usertracking', $input_data);
