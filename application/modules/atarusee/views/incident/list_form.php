                ...
                <div class="col-12">
                    ...
                    <?php
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9">
                                    <h3 class="card-title">Observation Management</h3>
                                </div>
                                <div class="col-md-3">
    ...
    $(function() {
        ...
        var table = $('#employeeid').DataTable({
            ...
            buttons: [
                ...
                //                     "<?php echo BASE_URL;  ?>atarusee/incident/exportpdf?" + qetquerystring()
                ...
                //                 window.location.href =
                //                     "<?php echo BASE_URL;  ?>atarusee/incident/exportexcel?" + qetquerystring()
