                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/monthly/inspection_list') ?>"><button type="button" class="btn btn-primary backBtns">Back</button></a>
                                </div>
                            </div>
                            <div class="card ">
                                <div class="card-body">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead style="background: #94960ae0; font-weight: bold; color:#fff; text-align:center;">
                                                    <tr style="background: #5a5a59 !important;">
                                                        ...
                                                        <td style="width:30%;">Items to be checked</td>
                                                        <td style="width:15%">Outcome</td>
                                                        ...
                                                        foreach ($groupedItems as $subcategory => $items): ?>
                                                            ...
                                                            <?php foreach ($items as $key => $item): ?>
                                                                ...
                                                                <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                                                                    ...
                                                                    <td class="text-center align-middle" style="border: 1px solid lightgray; "><?= $monthly_status[$item->insp_item_condition]; ?></td>
                                                            ...
                                                            <?php if (!empty($evidenceData) && is_array($evidenceData)): ?>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class=" align-middle" style="border: 1px solid lightgray;"><?php echo $descriptions; ?></td>
                                                                    </tr>
                                                                <?php endforeach; ?>
                                                            <?php else: ?>
                                                                <tr>
