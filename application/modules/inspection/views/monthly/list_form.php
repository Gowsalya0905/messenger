...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteIncident", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/monthly/delete_inspection"); ?>';
...
<script type="text/javascript">
    ...
    function qetquerystring() {
        ...
        return 'cat_id=' + cat_id + '&company_id=' + company_id + '&area_id=' + area_id + '&building_id=' + building_id + '&department_id=' + dept_id + '&project_id=' + project_id + '&start_date=' + start_date + '&end_date=' + end_date + '&NotifyStatus=' + notifystatus + '&searchvalue=' + searchvalue
    }
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/monthly/Monthly_exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/monthly/Monthly_exportexcel?" + qetquerystring()
