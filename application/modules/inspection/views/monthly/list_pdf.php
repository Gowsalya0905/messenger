                ...
                foreach ($groupedItems as $subcategory => $items): ?>
                    ...
                    <?php foreach ($items as $key => $item): ?>
                        ...
                        <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                            ...
                            <td class="t-center align-middle" style="border: 1px solid lightgray; font-size:12px"><?= $monthly_status[$item->insp_item_condition]; ?></td>
            ...
            <?php if (!empty($evidenceData) && is_array($evidenceData)): ?>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:12px"><?php echo $descriptions; ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
