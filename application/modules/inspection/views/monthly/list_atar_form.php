                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="float-right">
                                        ...
                                        ?>
                                        <!-- <a href="<?php // echo BASE_URL('inspection/monthly/add_inspection') ?>" class="btn btn-sm btn-primary "><i class="fa fa-plus-circle"></i> Add Inspection</a> -->
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteAtar", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/monthly/delete_atar"); ?>';
...
<script type="text/javascript">
    ...
    function qetquerystring() {
        ...
        return 'cat_id=' + cat_id + '&emp_name=' + emp_name + '&company_id=' + company_id + '&area_id=' + area_id + '&building_id=' + building_id + '&department_id=' + dept_id + '&project_id=' + project_id + '&start_date=' + start_date + '&end_date=' + end_date + '&NotifyStatus=' + notifystatus + '&mainStatus=' + mainStatus + '&searchvalue=' + searchvalue
    }
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/monthly/Monthly_atar_exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/monthly/Monthly_atar_exportexcel?" + qetquerystring()
