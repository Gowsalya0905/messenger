...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteIncident", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/weekly/delete_inspection"); ?>';
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/weekly/Weekly_exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/weekly/Weekly_exportexcel?" + qetquerystring()
