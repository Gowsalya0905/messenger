                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="float-right">
                                        ...
                                        ?>
                                        <!-- <a href="<?php // echo BASE_URL('inspection/weekly/add_inspection') ?>" class="btn btn-sm btn-primary "><i class="fa fa-plus-circle"></i> Add Inspection</a> -->
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteAtar", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/weekly/delete_atar"); ?>';
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/weekly/weekly_atar_exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/weekly/weekly_atar_exportexcel?" + qetquerystring()
