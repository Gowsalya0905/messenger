...
global $owner_list, $owner_engineer_list, $EPC_list, $audit_status,$risk_rating;
...
<body style="font-family:'calibri';">
    ...
    <table class="table table-striped table-bordered" style="border-collapse: collapse; border: 1px solid lightgray;">
        <thead style="background-color: #004EA3 !important; color: #fff !important; font-size:10px !important;">
            <tr>
                ...
                <th style="background-color: #004EA3 !important; color: #fff; width: 30%; padding: 5px; text-align: center; border: 1px solid lightgray; font-size:12px;">Guidance</th>
                ...
                foreach ($groupedItems as $subcategory => $items): ?>
                    ...
                    <?php foreach ($items as $key => $item): ?>
                        ...
                        <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                            ...
                            <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:12px"><?= $item->guidance; ?></td>
                            <td class="t-center align-middle" style="border: 1px solid lightgray; font-size:12px"><?= $audit_status[$item->insp_item_condition]; ?></td>
 ...
 <table class="table table-striped table-bordered" style="border-collapse: collapse; border: 1px solid lightgray; width: 100%; table-layout: fixed;">
    <thead style="background-color: #004EA3 !important; color: #fff !important; font-size: 14px !important;">
        <tr>
            <th style="background-color: #004EA3 !important; color: #fff; width: 15%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">ATAR ID</th>
            <th style="background-color: #004EA3 !important; color: #fff; width: 20%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">Assigned By</th>
            <th style="background-color: #004EA3 !important; color: #fff; width: 20%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">Responsible Person</th>
            <th style="background-color: #004EA3 !important; color: #fff; width: 15%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">Risk Level</th>
            <th style="background-color: #004EA3 !important; color: #fff; width: 15%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">Target Date</th>
            <th style="background-color: #004EA3 !important; color: #fff; width: 20%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">Images</th>
            <th style="background-color: #004EA3 !important; color: #fff; width: 15%; padding: 10px; text-align: center; border: 1px solid lightgray; font-size:14px;">Status</th>
        </tr>
    </thead>

    <tbody id="subcategory_table" style="border: 1px solid lightgray;">
    <?php if (!empty($atarData)):?>
        <?php foreach ($atarData as $item): ?>
            <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:14px; padding: 10px; text-align: center;">
                    <?= isset($item->insp_atar_uni_id) ? $item->insp_atar_uni_id : '-'; ?>
                </td>              
                <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:14px; padding: 10px; text-align: center;">
                    <?= isset($item->assigner) ? $item->assigner : '-'; ?>
                </td>
                <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:14px; padding: 10px; text-align: center;">
                    <?= isset($item->res_person) ? $item->res_person : '-'; ?>
                </td>
                <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:14px; padding: 10px; text-align: center;">
                    <?= isset($item->insp_assigner_target_date) ? $risk_rating[$item->insp_supervisor_risk_id] : '-'; ?>
                </td>
                <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:14px; padding: 10px; text-align: center;">
                    <?= isset($item->insp_assigner_target_date) ? $item->insp_assigner_target_date : '-'; ?>
                </td>
                <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:14px; padding: 10px; text-align: center;">
                    <?php
                        if (!empty($item->grouped_images)) {              
                            $imagePaths = explode(',', $item->grouped_images);               
                            foreach ($imagePaths as $imagePath) {
                                echo '<a href="' . base_url($imagePath) . '" target="_blank" class="text-primary" style="font-size:14px;">CA Image Link</a><br>';
                            }
                        }
                    ?>
                </td>
    ...
    <?php else: ?>
        <tr>
            <td colspan="7" style="text-align: center; border: 1px solid lightgray; font-size:14px; padding: 10px;">No data available</td>
        </tr>
    <?php endif; ?>
    </tbody>
</table>
