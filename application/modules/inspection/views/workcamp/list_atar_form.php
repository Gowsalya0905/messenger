...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteAtar", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/workcamp/delete_atar"); ?>';
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/workcamp/workcamp_atar_exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/workcamp/workcamp_atar_exportexcel?" + qetquerystring()
