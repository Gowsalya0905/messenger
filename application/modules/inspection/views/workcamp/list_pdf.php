    ...
    <table class="table table-striped table-bordered" style="border-collapse: collapse; border: 1px solid lightgray;">
        <thead style="background-color: #004EA3 !important; color: #fff !important; font-size:10px !important;">
            <tr>
                ...
                <th style="background-color: #004EA3 !important; color: #fff; width: 10%; padding: 5px; text-align: center; border: 1px solid lightgray; font-size:12px;">Score</th>
                <th style="background-color: #004EA3 !important; color: #fff; width: 35%; padding: 5px; text-align: center; border: 1px solid lightgray; font-size:12px;">Action</th>
            </tr>
        </thead>
                ...
                foreach ($groupedItems as $subcategory => $items): ?>
                    ...
                    <?php foreach ($items as $key => $item): ?>
                        ...
                        <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                            ...
                            <td class="t-center align-middle" style="border: 1px solid lightgray; font-size:12px"><?= $workcamp_status[$item->insp_item_condition]; ?></td>
                            <td class="text-center align-middle" style="border: 1px solid lightgray; font-size:12px"><?= $item->insp_score; ?></td>
