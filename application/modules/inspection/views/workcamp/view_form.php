                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/workcamp/inspection_list') ?>"><button type="button" class="btn btn-primary backBtns">Back</button></a>
                                </div>
                            </div>
                            <div class="card ">
                                <div class="card-body">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead style="background: #94960ae0; font-weight: bold; color:#fff; text-align:center;">
                                                    <tr style="background: #5a5a59 !important;">
                                                        ...
                                                        <td style="width:40%;">Items to be checked</td>
                                                        ...
                                                        foreach ($groupedItems as $subcategory => $items): ?>
                                                            ...
                                                            <?php foreach ($items as $key => $item): ?>
                                                                ...
                                                                <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                                                                    ...
                                                                    <td class="text-center align-middle" style="border: 1px solid lightgray; "><?= $workcamp_status[$item->insp_item_condition]; ?></td>
                                                                    <td class="text-left align-middle" style="border: 1px solid lightgray; "><?= $item->insp_score; ?></td>
