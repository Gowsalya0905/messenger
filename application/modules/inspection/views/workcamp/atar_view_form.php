...
global $risk_rating, $owner_list, $owner_engineer_list, $EPC_list, $workcamp_status;
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if ((is_admin() || $insp_assigner_id == $userid || $insPermission['view_ad']) && ($ins_app_status == 1 || $ins_app_status == 8)) {
                                        $url = 'inspection/workcamp/saveStatus/';
                                    } else if ($ins_app_status == 4 || $ins_app_status == 7) {
                                        $url = 'inspection/workcamp/saveCADetails/';
                                    } else if ($ins_app_status == 3) {
                                        $url = 'inspection/workcamp/saveCatDetails/';
                                    } else if ($ins_app_status == 5 || $ins_app_status == 10) {
                                        $url = 'inspection/workcamp/saveApproveDetails/';
                                    } else if ($ins_app_status == 9) {
                                        $url = 'inspection/workcamp/saveFinalApproveDetails/';
                                    }
                                            ...
                                            <div class="row viewpage">
                                                <div class="col-12 table-responsive">
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tr>
                                                            <td class="tdlabel"><b>Score</b></td>
                                                            <td class="title-colon">:</td>
                                                            <td colspan="4"><?php echo ($editData->insp_score != '') ? $editData->insp_score : '-'; ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="title-colon">:</td>
                                                            <td colspan="4"><?php echo ($editData->insp_item_condition != '') ? $workcamp_status[$editData->insp_item_condition] : '-'; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
