                ...
                <div class="col-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            ...
                            ?>
                                <a href="<?php echo BASE_URL('inspection/master/add_category') ?>" class="btn btn-sm btn-primary float-right resptarget">
                                    Add Category
                                </a>
                            <?php
                            }
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/master/category_exportpdf"
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/master/category_exportexcel"
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteCategory", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/master/delete_category"); ?>';
