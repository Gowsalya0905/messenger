                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/master/subcategory') ?>"><button type="button" class="btn btn-sm btn-primary backBtns"> Back</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <?php
                                ...
                                ?>
                                <?php echo form_open('inspection/master/save_subcategory/' . encryptval($cat_id), 'class="form-horizontal" id="company-profile" novalidate'); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status === true) {
                                    window.location.href = "<?php echo BASE_URL('inspection/master/subcategory'); ?>";
                                } else {
        ...
        $(".addsubcat").on("click", function(e) {
            ...
            html = '<div class="row m-t-10 m-b-10 m-l-10 remRowid" id="remRowid_' + finalRowid + '" row-id="' + finalRowid + '">\n\
                        <div class="col-sm-11">\n\
                                        <div class="form-group">\n\
