                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/master/workcampsubcategorydata') ?>"><button type="button" class="btn btn-sm btn-primary backBtns"> Back</button></a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                // print_r($editData);
                                ?>
                                <?php echo form_open('inspection/master/save_workcampsubcategorydata', 'class="form-horizontal" id="company-profile" novalidate'); ?>
    ...
    $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.status === true) {
                                    window.location.href = "<?php echo BASE_URL('inspection/master/workcampsubcategorydata'); ?>";
                                } else {
        ...
        $(".addsubtyp").on("click", function(e) {
            ...
            html = '<div class="row m-t-10 m-l-10 m-b-10 remRowid" id="remRowid_' + finalRowid + '" row-id="' + finalRowid + '">\n\
                        <div class="col-sm-11">\n\
                                        <div class="form-group">\n\
                                            <input type="text" name="main_mas[subcategorydata][]" value="" id="subtype_' + finalRowid + '" class="form-control" required="1" autocomplete="off" >\n\
        ...
        function getsubcatdata(cat_id) {
            ...
            var url = "<?php echo BASE_URL('inspection/master/getworkcampSubcategoryDetails') ?>";
            var data = {
                id: cat_id,
