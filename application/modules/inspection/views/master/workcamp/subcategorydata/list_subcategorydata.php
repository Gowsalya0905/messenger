                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="float-right">
                                        ...
                                        ?>
                                            <a href="<?php echo BASE_URL('inspection/master/add_workcampsubcategory_data') ?>" class="btn btn-sm btn-primary float-right">
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/master/workcampsubcategorydata_exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/master/workcampsubcategorydata_exportexcel?" + qetquerystring()
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteSubCategorydata", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/master/delete_workcampsubcategorydata"); ?>';
