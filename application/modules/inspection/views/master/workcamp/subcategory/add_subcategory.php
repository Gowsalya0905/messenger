                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/master/workcampsubcategory') ?>"><button type="button" class="btn btn-sm btn-primary backBtns"> Back</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <?php
                                ...
                                ?>
                                <?php echo form_open('inspection/master/save_workcampsubcategory/' . encryptval($cat_id), 'class="form-horizontal" id="company-profile" novalidate'); ?>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.status === true) {
                                    window.location.href = "<?php echo BASE_URL('inspection/master/workcampsubcategory'); ?>";
                                } else {
