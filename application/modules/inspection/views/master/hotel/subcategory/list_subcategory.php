                ...
                <div class="col-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            ...
                            ?>
                                <a href="<?php echo BASE_URL('inspection/master/add_hotelsubcategory') ?>" class="btn btn-sm btn-primary float-right ">
                                    Add Sub Category
                                </a>
                            <?php
                            }
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/master/hotelsubcategory_exportpdf"
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>inspection/master/hotelsubcategory_exportexcel"
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteSubCategory", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("inspection/master/delete_hotelsubcategory"); ?>';
