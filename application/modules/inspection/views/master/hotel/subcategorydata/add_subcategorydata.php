                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/master/hotelsubcategorydata') ?>"><button type="button" class="btn btn-sm btn-primary backBtns"> Back</button></a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                // print_r($editData);
                                ?>
                                <?php echo form_open('inspection/master/save_hotelsubcategorydata', 'class="form-horizontal" id="company-profile" novalidate'); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.status === true) {
                                    window.location.href = "<?php echo BASE_URL('inspection/master/hotelsubcategorydata'); ?>";
                                } else {
        ...
        function getsubcatdata(cat_id) {
            ...
            var url = "<?php echo BASE_URL('inspection/master/gethotelSubcategoryDetails') ?>";
            var data = {
                id: cat_id,
