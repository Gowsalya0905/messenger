...
echo form_open('inspection/master/save_hotelcategory/' . $editRespid, 'class="form-horizontal" id="category_form" novalidate')
?>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if ($("#category_form").valid()) {
                        ...
                        var url = "<?php echo BASE_URL('inspection/master/save_hotelcategory') ?>";
