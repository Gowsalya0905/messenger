...
global $risk_rating, $owner_list, $owner_engineer_list, $EPC_list, $hotel_status;
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if ((is_admin() || $insp_assigner_id == $userid || $insPermission['view_ad']) && ($ins_app_status == 1 || $ins_app_status == 8)) {
                                        $url = 'inspection/hotel/saveStatus/';
                                    } else if ($ins_app_status == 4 || $ins_app_status == 7) {
                                        $url = 'inspection/hotel/saveCADetails/';
                                    } else if ($ins_app_status == 3) {
                                        $url = 'inspection/hotel/saveCatDetails/';
                                    } else if ($ins_app_status == 5 || $ins_app_status == 10) {
                                        $url = 'inspection/hotel/saveApproveDetails/';
                                    } else if ($ins_app_status == 9) {
                                        $url = 'inspection/hotel/saveFinalApproveDetails/';
                                    }
                                                ...
                                                <div class="col-12 table-responsive">
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="title-colon">:</td>
                                                            <td colspan="4"><?php echo ($editData->insp_item_condition != '') ? $hotel_status[$editData->insp_item_condition] : '-'; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
