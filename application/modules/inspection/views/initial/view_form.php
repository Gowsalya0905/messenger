                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo BASE_URL('inspection/initial/inspection_list') ?>"><button type="button" class="btn btn-primary backBtns">Back</button></a>
                                </div>
                            </div>
                            <div class="card ">
                                <div class="card-body">
                                                        ...
                                                        foreach ($groupedItems as $subcategory => $items): ?>
                                                            ...
                                                            <?php foreach ($items as $key => $item): ?>
                                                                ...
                                                                <tr class="border-top border-secondary" style="border: 1px solid lightgray;">
                                                                    ...
                                                                    <td class="text-center align-middle" style="border: 1px solid lightgray; "><?= $initial_status[$item->insp_item_condition]; ?></td>
