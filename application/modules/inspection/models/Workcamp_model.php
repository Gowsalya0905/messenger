...
class Workcamp_model extends CI_Model
{
    ...
    public function getInspImagBefore_project($did = '')
    {
        ...
        return $details = $this->common->getAlldata(INSP_WORKCAMP_IMAGE_SEE, ['*'], $option);
    }
    ...
    public function getAtarDetails_project($where, $type, $option = [])
    {
        ...
        $option['join'] = [
            ...
            // LOGIN . ' AS LD1' => ['LD1.LOGIN_ID = ' . INSP_WORKCAMP_FLOW_SEE . '.obs_supervisor_id', 'LEFT'],
            // EMPL . ' AS Hsse' => ['Hsse.EMP_AUTO_ID = LD1.USER_REF_ID', 'LEFT'],

            // LOGIN . ' AS LD5' => ['LD5.LOGIN_ID = ' . INSP_WORKCAMP_FLOW_SEE . '.obs_assigner_id', 'LEFT'],
            // EMPL . ' AS Unithead' => ['Unithead.EMP_AUTO_ID = LD5.USER_REF_ID', 'LEFT'],


            // OBS_RISK_LOG . ' AS RL' => [
            //     "RL.fk_obs_risk_auto_main_id = " . INSP_WORKCAMP_FLOW_SEE . ".obs_auto_id  AND RL.obs_risk_assigned_type_id = 1",
            //     "LEFT"
            // ],

            // 'LOGIN_DETAILS AS LD4'=>['LD4.LOGIN_ID = '.OBS_FLOW.'.obs_assigner_id','LEFT'],
            // 'CONTRACTOR_DETAILS AS Hodcon'=>['Hodcon.CONT_AUTO_ID = LD4.USER_REF_ID','LEFT'],


            // 'LOGIN_DETAILS AS LD3'=>['LD3.LOGIN_ID = '.OBS_FLOW.'.obs_reporter_id','LEFT'],
            // 'CONTRACTOR_DETAILS AS Contractor'=>['Contractor.CONT_AUTO_ID = LD3.USER_REF_ID','LEFT'],

            'insp_workcamp_category_master AS ins_cate_mas'=>['ins_cate_mas.id = '.INSP_WORKCAMP_ITEMS.'.fk_item_cat_id','LEFT'],
            'insp_workcamp_subcategory_master AS ins_subcate_mas'=>['ins_subcate_mas.id = '.INSP_WORKCAMP_ITEMS.'.fk_item_subcat_id','LEFT'],
            'insp_workcamp_subcategorydata_master AS ins_subcatedata_mas'=>['ins_subcatedata_mas.id = '.INSP_WORKCAMP_ITEMS.'.fk_item_subcatdata_id','LEFT'],
        ...
        return $details = $this->common->getAlldata(INSP_WORKCAMP_ITEMS, [
            '*',
            'insp_main.ins_id',
    ...
    public function getInspDataReassign_project($did = "")
    {
        ...
        $option["join"] = [
            LOGIN . " AS LD6" => [
                "LD6.LOGIN_ID = " . INSP_WORKCAMP_ESL_LOG . ".fk_insp_supervisor_login_id",
                "LEFT",
            ],
            EMPL . " AS repman" => [
            ...
            LOGIN . " AS LD7" => [
                "LD7.LOGIN_ID = " . INSP_WORKCAMP_ESL_LOG . ".fk_new_assigner_id",
                "LEFT",
            ],
            EMPL . " AS aiemp" => [
    ...
    public function getInspDataapproval_project($did = "")
    {
        ...
        $option["join"] = [
            LOGIN . " AS LD6" => [
                "LD6.LOGIN_ID = " . INSP_WORKCAMP_APP_ESL_LOG . ".approver_login_id",
                "LEFT",
            ],
            EMPL . " AS repman" => [
                "repman.EMP_AUTO_ID = LD6.USER_REF_ID",
            ...
            LOGIN . " AS LD7" => [
                "LD7.LOGIN_ID = " . INSP_WORKCAMP_APP_ESL_LOG . ".fk_assigner_login_id",
                "LEFT",
            ],
            EMPL . " AS aiemp" => [
                "aiemp.EMP_AUTO_ID = LD7.USER_REF_ID",
    ...
    public function getInspDataactiontaken_project($did = "")
    {
        ...
        $option["join"] = [
            LOGIN . " AS LD6" => [
                "LD6.LOGIN_ID = " . INSP_WORKCAMP_ACTION_LOG . ".fk_insp_assigner_login_id",
                "LEFT",
            ],
            EMPL . " AS repman" => [
                "repman.EMP_AUTO_ID = LD6.USER_REF_ID",
            ...
            INSP_WORKCAMP_IMAGE_SEE . " AS insimg" => [ // Join with obs_image_upload
                "insimg.fk_ca_log_id = " . INSP_WORKCAMP_ACTION_LOG . ".ca_log_id",
                "LEFT",
            ],
        ];
