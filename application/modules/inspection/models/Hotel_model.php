...
class Hotel_model extends CI_Model
{
    ...
    public function getInspImagBefore_project($did = '')
    {
        ...
        return $details = $this->common->getAlldata(INSP_HOTEL_IMAGE_SEE, ['*'], $option);
    }
    ...
    public function getAtarDetails_project($where, $type, $option = [])
    {
        ...
        $option['join'] = [
            ...
            'insp_monthly_category_master AS ins_cate_mas'=>['ins_cate_mas.id = '.INSP_HOTEL_ITEMS.'.fk_item_cat_id','LEFT'],
            'insp_monthly_subcategory_master AS ins_subcate_mas'=>['ins_subcate_mas.id = '.INSP_HOTEL_ITEMS.'.fk_item_subcat_id','LEFT'],
            'insp_monthly_subcategorydata_master AS ins_subcatedata_mas'=>['ins_subcatedata_mas.id = '.INSP_HOTEL_ITEMS.'.fk_item_subcatdata_id','LEFT'],
              INSP_HOTEL_FLOW_SEE.' AS insp_main'=>['insp_main.ins_auto_id = '.INSP_HOTEL_ITEMS.'.fk_insp_main_auto_id','LEFT'],

        ];
        $aOption = $option + $option;

        return $details = $this->common->getAlldata(INSP_HOTEL_ITEMS, [
            '*',
            'insp_main.ins_id',
    ...
    public function getInspDataReassign_project($did = "")
    {
        ...
        $option["join"] = [
            LOGIN . " AS LD6" => [
                "LD6.LOGIN_ID = " . INSP_HOTEL_ESL_LOG . ".fk_insp_supervisor_login_id",
                "LEFT",
            ],
            EMPL . " AS repman" => [
            ...
            LOGIN . " AS LD7" => [
                "LD7.LOGIN_ID = " . INSP_HOTEL_ESL_LOG . ".fk_new_assigner_id",
                "LEFT",
            ],
            EMPL . " AS aiemp" => [
    ...
    public function getInspDataapproval_project($did = "")
    {
        ...
        $option["join"] = [
            LOGIN . " AS LD6" => [
                "LD6.LOGIN_ID = " . INSP_HOTEL_APP_ESL_LOG . ".approver_login_id",
                "LEFT",
            ],
            EMPL . " AS repman" => [
                "repman.EMP_AUTO_ID = LD6.USER_REF_ID",
            ...
            LOGIN . " AS LD7" => [
                "LD7.LOGIN_ID = " . INSP_HOTEL_APP_ESL_LOG . ".fk_assigner_login_id",
                "LEFT",
            ],
            EMPL . " AS aiemp" => [
                "aiemp.EMP_AUTO_ID = LD7.USER_REF_ID",
    ...
    public function getInspDataactiontaken_project($did = "")
    {
        ...
        $option["join"] = [
            LOGIN . " AS LD6" => [
                "LD6.LOGIN_ID = " . INSP_HOTEL_ACTION_LOG . ".fk_insp_assigner_login_id",
                "LEFT",
            ],
            EMPL . " AS repman" => [
                "repman.EMP_AUTO_ID = LD6.USER_REF_ID",
            ...
            INSP_HOTEL_IMAGE_SEE . " AS insimg" => [ // Join with obs_image_upload
                "insimg.fk_ca_log_id = " . INSP_HOTEL_ACTION_LOG . ".ca_log_id",
                "LEFT",
            ],
        ];
