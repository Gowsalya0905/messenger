                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" name="inspec[trainer_login_id]"
                                            value="<?php echo $practical_reporter_session_id; ?>">
                                        <!--<input type="hidden" name="inspec[emp_login_id]" value="<?php echo $nom_emp_login_id; ?>">-->
                                        <!--<input type="hidden" name="inspec[emp_nom_auto_id]" value="<?php echo $nom_emp_auto_id; ?>">-->
                                        <input type="hidden" name="inspec[training_auto_id]"
                                            value="<?php echo $trainAutoID; ?>">
                                ...
                                <?php
                                if (isset($getEmployeedatas) && !empty($getEmployeedatas)) {
                                    ?>
                                        ...
                                        <div class="row emplDetoth table-responsive" style="margin:10px;">
                                            ...
                                            <div class="col-sm-12 ">
                                                <table id="" class="table table-bordered table-striped">
                                                    ...
                                                    <thead
                                                        style="background: linear-gradient(45deg, #5a5a59, #5a5a59);color: #ffffff;">
                                                        <tr>
                                                            <th> S.No </th>
                                                            <th> Employee ID </th>
                                                            <th> Employee Name </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($getEmployeedatas as $othKey => $othVal) {
                                                            ...
                                                            $othCertiID = postData($othVal, 'hse_training_employee_id');
                                                            $empID = postData($othVal, 'EMP_ID');
                                                            $othempsurname = postData($othVal, 'EMP_NAME');
                                                            $othdeptname = postData($othVal, 'dept_name');
                                                            $othtrainingID = postData($othVal, 'hse_training_id');
                                                            
                                                            $attendanceID = postData($othVal, 'mark_attendance');
                                                            
                                                            if($attendanceID == 1){
                                                                $aACCESS = 1;
                                                            }elseif ($attendanceID == 2) {
                                                                         $aACCESS = 2;    
                                                                        } else {
                                                                             $aACCESS = 0;
                                                                        }
                                                        ...
                                                        <tr certiRow-id="<?php echo $certiRowval; ?>">
                                                            <td>
                                                                ...
                                                                <input type="hidden"
                                                                    name="nom[<?php echo $certiRowval; ?>][hse_training_emp_auto_id]"
                                                                    value="<?php echo $othCertiID; ?>">
                                                                <input type="hidden"
                                                                    name="nom[<?php echo $certiRowval; ?>][hse_training_auto_id]"
                                                                    value="<?php echo $othtrainingID; ?>">
                                                            ...
                                                            <td>
                                                                <?php echo $othempsurname; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $othdeptname; ?>
                                                            </td>
                                                            ...
                                                            <td style="width:15%">
                                                                <?php
                                                                       ...
                                                                       // echo form_hidden('nom['.$certiRowval.'][attendances]', $aACCESS);
