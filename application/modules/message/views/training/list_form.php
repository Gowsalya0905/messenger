<?php
$select_company = $select_area = $select_building  =  $select_dep = $select_proj = $select_status = $select_hse_cat  = $select_obs_type = $select_risk_id = $select_fac_id = $select_startdate = $select_enddate = $select_main_status = '';
...
if (isset($getdashdata['hse_cat']) && $getdashdata['hse_cat'] != '') {
    $select_hse_cat = $getdashdata['hse_cat'];
}


if (isset($getdashdata['obs_type']) && $getdashdata['obs_type'] != '') {
    $select_obs_type = $getdashdata['obs_type'];
}

if (isset($getdashdata['risk_id']) && $getdashdata['risk_id'] != '') {
    $select_risk_id = $getdashdata['risk_id'];
}
                ...
                <div class="col-12">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9">
                                    <h3 class="card-title">Training Management</h3>
                                </div>
                                <div class="col-md-3">
                                    <div class="float-right">
                                        ...
                                        ?>
                                        <a href="<?php echo BASE_URL('training/training/addHmp') ?>" class="btn btn-sm btn-primary "><i class="fa fa-plus-circle"></i> Add Observation</a>
                                        <?php
                                        // }
                        ...
                        <div class="card-body">
                            <div id="search" class="collapse">
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <?php
                                    if (in_array($user_type, $trPermission['view_filter'])) {
                                    ...
                                    <div class="col-md-3 m-t-10">
                                        ...
                                        <div>
                                            ...
                                            echo form_dropdown('hse_cat', $drophsecat, $select_hse_cat, $cNamedatas_pl);
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 m-t-10">
                                        ...
                                        <div>
                                            ...
                                            echo form_dropdown('obs_type', $obs_type_list, $select_obs_type, $cNamedatas_pl);
                                            ?>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleteIncident", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("training/training/deleteData"); ?>';
...
<script type="text/javascript">
    ...
    function qetquerystring() {
        ...
        return 'hse_cat=' + hse_cat + '&obs_type=' + obs_type + '&risk_id=' + risk_id + '&emp_name=' + emp_name + '&company_id=' + company_id + '&area_id=' + area_id + '&building_id=' + building_id + '&department_id=' + dept_id + '&project_id=' + project_id + '&start_date=' + start_date + '&end_date=' + end_date + '&Month=' + Month + '&NotifyStatus=' + notifystatus + '&mainStatus=' + mainStatus + '&searchvalue=' + searchvalue
    }
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>training/training/exportpdf?" + qetquerystring()
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>training/training/exportexcel?" + qetquerystring()
