...
<div class="modal-header">
    <?php if ($editRespid) { ?>
        <h3 class="modal-title"> Question Type</h3>
    <?php } else { ?>
        <h3 class="modal-title"> Question Type</h3>
    <?php } ?>
...
echo form_open('training/master/save_question_master/' . $editRespid, 'class="form-horizontal" id="question_form" novalidate')
?>
...
<div class="modal-body">
    ...
    <div class="form-group">
        <label for="loctyp"> Type<span class="error"> * </span></label>
        <?php
        $editRespname = postData($getCategories, 'question');
        $respName = [
            'name' => 'main_mas[question]',
            'id' => 'question',
            'class' => 'form-control',
        ...
        ?>
        <span class="error type_err"><?php echo form_error('main_mas[question]') ?></span>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if ($("#question_form").valid()) {
                        ...
                        var url = "<?php echo BASE_URL('training/master/save_question_master') ?>";
