    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="" style="margin-top:10px;">
                <?php
                echo $this->session->flashdata('questionflash');
                $this->session->unset_userdata('questionflash'); ?>
            </div>
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            ...
                            ?>
                                <a href="<?php echo BASE_URL('training/master/add_question_master') ?>" class="btn btn-sm btn-primary float-right resptarget">
                                    Add Question
                                </a>
                            <?php
                            }
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>training/master/question_master_exportpdf"
                        ...
                        },
                        {
                            ...
                            action: function(e, dt, button, config) {
                                ...
                                window.location.href =
                                    "<?php echo BASE_URL;  ?>training/master/question_master_exportexcel"
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deletequestion", function(e) {
            e.preventDefault();
            var url = '<?php echo BASE_URL("training/master/delete_question_master"); ?>';
