    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="" style="margin-top:10px;">
                <?php echo $this->session->flashdata('locatn'); ?>
            </div>
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            ...
                            <a href="<?php echo BASE_URL('master/UserType/mapping') ?>" class="btn btn-sm btn-primary float-right" >Add Usertype-Designation Mapping</a>
                        </div>
