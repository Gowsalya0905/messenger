                ...
                <div class="col-12">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9">
                                    <h3 class="card-title">OBS Category-Weekly Report</h3>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="card radius-10 border-top border-0 border-4 border-primary">
                                    <div class="card-body" id="">
                                        <div class="col-md-12" id="LoadOBSCATEGORYWEEK">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function load_hse_category_table() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#LoadOBSCATEGORYWEEK').html(response);
                }
            });
        }
        ...
        $('#export_excel').click(function() {
            ...
            var downloadUrl = "<?php echo BASE_URL(); ?>report/obs_category__week_exportexcel?" + queryString;
