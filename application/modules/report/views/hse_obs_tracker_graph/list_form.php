                ...
                <div class="col-12">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9">
                                    <h3 class="card-title">HSE OBS Tracker Graph</h3>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-md-3 m-t-10 d-none">
                                        ...
                                        <div>
                                            ...
                                            echo form_dropdown('fac_injury', $dropinjcat, '', $cNamedatas_pl);
                                            ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="card radius-10 border-top border-0 border-4 border-primary">
                                    <div class="card-body" id="">
                                        <div class="col-md-12" id="LoadHSEObsTracker">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function qetquerystring() {
        ...
        return 'hse_cat=' + hse_cat + '&fac_injury=' + fac_injury + '&obs_type=' + obs_type + '&risk_id=' + risk_id + '&emp_name=' + emp_name + '&company_id=' + company_id + '&area_id=' + area_id + '&building_id=' + building_id + '&department_id=' + dept_id + '&project_id=' + project_id + '&start_date=' + start_date + '&end_date=' + end_date + '&NotifyStatus=' + notifystatus + '&searchvalue=' + searchvalue
    }
    ...
    $(function() {
        ...
        // / Datatable /
        load_hse_obs_tracker_graph_table();


        function load_hse_obs_tracker_graph_table() {
            $('#LoadHSEObsTracker').html('');
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#LoadHSEObsTracker').html(response);
                }
            });
        }
        ...
        $('#export_excel').click(function() {
            ...
            var downloadUrl = "<?php echo BASE_URL(); ?>report/hse_obs_tracker_exportexcel?" + queryString;
