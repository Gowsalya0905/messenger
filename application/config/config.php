...
//$config['sess_save_path'] = DB_PREFIX.'sessions';
...
if (stripos($_SERVER["REQUEST_URI"], '/' . APIURL) !== FALSE) {
    $config['csrf_protection']     = FALSE;
} else {
    $config['csrf_protection']     = TRUE;
}
$config['csrf_token_name'] = 'csrf_osh_name';
$config['csrf_cookie_name'] = 'csrf_cookie_name';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = FALSE; //turn this to true generate new token on every request(page/ajax)
$config['csrf_exclude_uris'] = array();
/*
|--------------------------------------------------------------------------
| Output Compression
